...
/* harmony default export */ __webpack_exports__["default"] = (class extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  static async getInitialProps(ctx) {
    ...
    try {
      ...
      const documentProps = await next_document__WEBPACK_IMPORTED_MODULE_1___default.a.getInitialProps(ctx);
      return _objectSpread({}, documentProps, {
        helmet: react_helmet__WEBPACK_IMPORTED_MODULE_3___default.a.renderStatic(),
        styles: __jsx(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null, documentProps.styles, sheet.getStyleElement())
      });
    } finally {
      sheet.seal();
    }
  ...
  get helmetJsx() {
    ...
    return __jsx(react_helmet__WEBPACK_IMPORTED_MODULE_3___default.a, null, __jsx("title", null, title), __jsx("meta", {
      charSet: "UTF-8"
    }), __jsx("meta", {
      name: "viewport",
  ...
  render() {
    return __jsx("html", this.helmetHtmlAttrComponents, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Head"], null, __jsx("link", {
      rel: "manifest",
      href: "/static/manifest.json"
    }), this.helmetJsx, this.helmetHeadComponents), __jsx("body", this.helmetBodyAttrComponents, __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["Main"], null), __jsx(next_document__WEBPACK_IMPORTED_MODULE_1__["NextScript"], null)));
  }
